...
$.fn.flip = function(settings){
    return this.each( function() {
		...
		var revertedSettings = {
			...
			bgColor: acceptHexColor(settings.color) || "#000",
        ...
        flipObj = {
            ...
            toColor: acceptHexColor(settings.color) || "#2b2b2b",
            speed: settings.speed || 500,
            top: $this.offset().top,
        ...
        $clone= $this.css("visibility","hidden")
            ...
            .appendTo("body")
            .html("")
            .css({visibility:"visible",position:"absolute",left:flipObj.left,top:flipObj.top,margin:0,zIndex:9999,"-webkit-box-shadow":"0px 0px 0px #2b2b2b","-moz-box-shadow":"0px 0px 0px #2b2b2b"});
